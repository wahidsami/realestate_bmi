...
import { authenticate, authorize, optionalAuthenticate } from '../middlewares/authenticate.js';
...
visualPagesRouter.get('/', optionalAuthenticate, listVisualPages);
visualPagesRouter.get('/:id', optionalAuthenticate, getVisualPageById);
